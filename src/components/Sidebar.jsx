...
const Sidebar = () => {
  ...
  // Lista de navegación actualizada con Publicidad
  const menuItems = [
  ...
  return (
    <div className="w-64 bg-[#111827] border-r border-gray-800 flex flex-col h-screen sticky top-0 z-50">
      {/* LOGO AREA */}
      <div className="p-8">
        <h1 className="text-3xl font-black text-blue-500 tracking-tighter italic">Pana Voy</h1>
      ...
      <div className="p-4 border-t border-gray-800/50">
        <button
          onClick={logout}
          className="w-full flex items-center gap-4 px-4 py-4 text-red-500 hover:bg-red-500/10 rounded-2xl transition-all duration-300 font-black text-xs uppercase tracking-widest group"
        >
